...
1. Copy `outputs` directory from MS3 to MS5 \
Also copy `top.sdc` from MS2 to MS5/outputs, becasue the sdc file from MS3 generated by Cadence Innovus has compatibility issues with PrimeTime tool \
Please double check the line 77 of `.synopsys_pt.setup`, which is the db files path in MS2
...
source /cae/apps/env/synopsys-PrimeTime-2024
