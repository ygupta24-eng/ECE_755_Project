module pe #(
    ...
    // 4 directional inputs kept — PE array wires these from neighbours' act_out
    ...
    // Single output — replaces act_to_left/right/up/down
    // PE array uses dst_sel to route this to correct neighbour's act_from_*
    ...
    // ── Single act_out ────────────────────────────────────────────
    // Replaces the 4 separate act_to_* outputs.
    // PE array reads act_out and, using this PE's dst_sel,
    // connects it to the correct neighbour's act_from_* port.
