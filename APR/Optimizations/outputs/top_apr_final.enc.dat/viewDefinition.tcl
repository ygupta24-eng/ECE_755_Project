...
create_delay_corner -name delay_tc\
   -library_set tc\
   -rc_corner rc_typ_25
create_constraint_mode -name sdc_cg\
   -sdc_files\
    [list ${::IMEX::dataVar}/mmmc/modes/sdc_cg/sdc_cg.sdc]
create_analysis_view -name view_tc -constraint_mode sdc_cg -delay_corner delay_tc -latency_file ${::IMEX::dataVar}/mmmc/views/view_tc/latency.sdc
set_analysis_view -setup [list view_tc] -hold [list view_tc]
catch {set_interactive_constraint_mode [list sdc_cg] } 
