...
## 1. Download Library
Copy the library to the MS_2_Synthesis folder:
````
cd MS_2_Synthesis
...
## enviroment setup
export LD_LIBRARY_PATH=/cae/apps/data/synopsys-2024/lc/V-2023.12-SP5/linux64/nwtn/shlib:${LD_LIBRARY_PATH}
export TERM=xterm-basic
source /cae/apps/env/synopsys-lc_vV-2023.12-SP5
...
## 3. Synthesis
0. Return to MS_2_Synthesis directory and copy your verilog files into it.
...
export LD_LIBRARY_PATH=/cae/apps/data/synopsys-2024/lc/V-2023.12-SP5/linux64/nwtn/shlib:${LD_LIBRARY_PATH}
export TERM=xterm-basic
source /cae/apps/env/synopsys-dc_shell-vV-2023.12-SP5
````
